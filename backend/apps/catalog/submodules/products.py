"""products submodule. Primary key: ((category_id, sku))."""
...
class ProductsRepository(BaseRepository):
    keyspace = KEYSPACE
    table = TABLE
    primary_key_columns = ("category_id", "sku")
...
class ProductSerializer(serializers.Serializer):
    ...
    stock_qty = serializers.IntegerField(required=False, allow_null=True)
    ...
    restock_time = serializers.TimeField(required=False, allow_null=True)
