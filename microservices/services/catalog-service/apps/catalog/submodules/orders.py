"""orders submodule. Primary key: ((order_id, placed_at))."""
...
class OrdersRepository(BaseRepository):
    keyspace = KEYSPACE
    table = TABLE
    primary_key_columns = ("order_id", "placed_at")


class OrderSerializer(serializers.Serializer):
    order_id = serializers.UUIDField()
    placed_at = serializers.UUIDField()
    item_count = serializers.IntegerField(required=False, allow_null=True)
    customer_id = serializers.IntegerField(required=False, allow_null=True)
    order_total_cents = serializers.IntegerField(required=False, allow_null=True)
    discount_rate = serializers.FloatField(required=False, allow_null=True)
    tax_amount = serializers.FloatField(required=False, allow_null=True)
    confirmed_at = serializers.DateTimeField(required=False, allow_null=True)
    delivery_date = serializers.DateField(required=False, allow_null=True)
    order_window = serializers.TimeField(required=False, allow_null=True)
