"""shipments submodule. Primary key: ((carrier_id, tracking_code, leg_no))."""
...
class ShipmentsRepository(BaseRepository):
    keyspace = KEYSPACE
    table = TABLE
    primary_key_columns = ("carrier_id", "tracking_code", "leg_no")


class ShipmentSerializer(serializers.Serializer):
    carrier_id = serializers.IntegerField()
    tracking_code = serializers.CharField()
    leg_no = serializers.IntegerField()
    leg_count = serializers.IntegerField(required=False, allow_null=True)
    parcel_count = serializers.IntegerField(required=False, allow_null=True)
    ...
    shipping_cost = serializers.FloatField(required=False, allow_null=True)
